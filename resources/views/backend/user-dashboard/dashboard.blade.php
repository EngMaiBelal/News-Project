      ...
      <section id="profile" class="content-section active">
          ...
          <section id="add-post" class="add-post-section mb-5">
              ...
              <div class="post-form p-3 border rounded">
                <form action="{{ route('home.user.dashboard.profile.post.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Post Title -->
                    <input name="title" value="{{ old('title')}}" type="text" id="postTitle" class="form-control mb-2" placeholder="Post Title" />
  
                    <!-- Post Content -->
                    <textarea name="description" id="postContent" class="form-control mb-2" rows="3" placeholder="What's on your mind?">{{ old('description')}}</textarea>
  
                    <!-- Image Upload -->
                    <input name="image" type="file" value="{{ old('image')}}" id="postImage" class="form-control mb-2" accept="image/*" multiple />
                    <div class="tn-slider mb-2">
                        <div id="imagePreview" class="slick-slider"></div>
                    </div>
  
                    <!-- Category Dropdown -->
                    <select name="category_id" value="{{ old('category')}}" id="postCategory" class="form-select mb-2 form-control">
                   ...
                   <br>
                    ...
                    <label value="{{ old('category')}}" class="form-check-label mb-2 ml-4 lable">
                        <input type="hidden" name="comment_able" value="off">
                        <input name="comment_able" type="checkbox" class="form-check-input" value="on"/> Enable Comments
                    </label><br>
                      ...
                      <div id="newsCarousel" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner">
                              <div class="carousel-item  active">
                                  <img src="{{ asset(auth()->user()->image)}}" class="d-block w-100" alt="First Slide">
